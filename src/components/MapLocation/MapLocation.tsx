...
const MapLocation = (props: MapLocationProps): JSX.Element => {
  ...
  const MapMobile = () => {
    return (
      <svg
        className={classNames(styles.mapSvg, styles.mapSvgMobile)}
        id="Map-svg"
        viewBox="0 0 670.2 432.4"
        style={{ 'enable-background': 'new 0 0 670.2 432.4;' } as CSSProperties}
        xmlSpace="preserve"
        version="1.1"
      ...
      >
        ...
        <g id="Map-texts">
          <text
            y={positionsMobile.brPA.y + positionTextShift.y}
          ...
          >
            <tspan
              x={positionsMobile.brPA.x + positionTextShift.x}
              textAnchor="middle"
          ...
          <text
            y={positionsMobile.brSC.y + positionTextShift.y}
            className={classNames(
              styles.pinTextWrapper,
          ...
          >
            <tspan
              x={positionsMobile.brSC.x + positionTextShift.x}
              textAnchor="middle"
              className={styles.pinText}
            >
              {t('map_br_sc')}
          ...
          <text
            y={positionsMobile.brMG.y + positionTextShift.y}
            className={classNames(
              styles.pinTextWrapper,
          ...
          >
            <tspan
              x={positionsMobile.brMG.x + positionTextShift.x}
              textAnchor="middle"
              className={styles.pinText}
            >
              {t('map_br_mg')}
          ...
          <text
            y={positionsMobile.ch.y + positionTextShift.y}
            className={classNames(
              styles.pinTextWrapper,
          ...
          >
            <tspan
              x={positionsMobile.ch.x + positionTextShift.x}
              textAnchor="middle"
              className={styles.pinText}
            >
              {t('map_ch')}
          ...
          <text
            y={positionsMobile.ru.y + positionTextShift.y}
            className={classNames(
              styles.pinTextWrapper,
          ...
          >
            <tspan
              x={positionsMobile.ru.x + positionTextShift.x}
              textAnchor="middle"
              className={styles.pinText}
            >
              {t('map_ru')}
          ...
          <text
            y={positionsMobile.ma.y + positionTextShift.y}
            className={classNames(
              styles.pinTextWrapper,
          ...
          >
            <tspan
              x={positionsMobile.ma.x + positionTextShift.x}
              textAnchor="middle"
              className={styles.pinText}
            >
              {t('map_ma')}
          ...
          <text
            y={positionsMobile.es.y + positionTextShift.y}
            className={classNames(
              styles.pinTextWrapper,
          ...
          >
            <tspan
              x={positionsMobile.es.x + positionTextShift.x}
              textAnchor="middle"
              className={styles.pinText}
            >
              {t('map_es')}
          ...
          <text
            y={positionsMobile.tr.y - positionTextShift.y}
            className={classNames(
              styles.pinTextWrapper,
          ...
          >
            <tspan
              x={positionsMobile.tr.x + positionTextShift.x}
              textAnchor="middle"
              className={styles.pinText}
            >
              {t('map_tr')}
    ...
    l25.7-25h15.9l12.5-13.1l5.7,6.1h8.2l-0.1,16.5l-8.9,9.5h30.2l8.8,9h44l14.3,14h16.3l2.3-3h15.5l10.3,11.4L654,142.2z"
          ...
          <g data-location="BR-pa" className={styles.pin1}>
            <circle
              ...
              cx={positionsMobile.brPA.x}
              cy={positionsMobile.brPA.y}
              r="2.5"
              fill="#fff"
              fillOpacity="0.5"
            />
          ...
          <g data-location="BR-sc" className={styles.pin2}>
            <circle
              className={styles.pinBack}
              cx={positionsMobile.brSC.x}
              cy={positionsMobile.brSC.y}
              r="2.5"
              fill="#fff"
              fillOpacity="0.5"
            />
          ...
          <g data-location="BR-mg" className={styles.pin3}>
            <circle
              className={styles.pinBack}
              cx={positionsMobile.brMG.x}
              cy={positionsMobile.brMG.y}
              r="2.5"
              fill="#fff"
              fillOpacity="0.5"
            />
          ...
          <g data-location="CH" className={styles.pin4}>
            <circle
              className={styles.pinBack}
              cx={positionsMobile.ch.x}
              cy={positionsMobile.ch.y}
              r="2.5"
              fill="#fff"
              fillOpacity="0.5"
            />
          ...
          <g data-location="RU" className={styles.pin5}>
            <circle
              className={styles.pinBack}
              cx={positionsMobile.ru.x}
              cy={positionsMobile.ru.y}
              r="2.5"
              fill="#fff"
              fillOpacity="0.5"
            />
          ...
          <g data-location="MA" className={styles.pin6}>
            <circle
              className={styles.pinBack}
              cx={positionsMobile.ma.x}
              cy={positionsMobile.ma.y}
              r="2.5"
              fill="#fff"
              fillOpacity="0.5"
            />
          ...
          <g data-location="ES" className={styles.pin7}>
            <circle
              className={styles.pinBack}
              cx={positionsMobile.es.x}
              cy={positionsMobile.es.y}
              r="2.5"
              fill="#fff"
              fillOpacity="0.5"
            />
          ...
          <g data-location="TR" className={styles.pin8}>
            <circle
              className={styles.pinBack}
              cx={positionsMobile.tr.x}
              cy={positionsMobile.tr.y}
              r="2.5"
              fill="#fff"
              fillOpacity="0.5"
            />
  ...
  const MapDesktop = () => {
    return (
      <svg
        className={classNames(styles.mapSvg, styles.mapSvgDesktop)}
        xmlns="http://www.w3.org/2000/svg"
        style={{ 'enable-background': 'new 0 0 950 620;' } as CSSProperties}
        viewBox="0 0 950 620"
        xmlSpace="preserve"
        version="1.1"
        xmlnsXlink="http://www.w3.org/1999/xlink"
      ...
      >
        <defs>
          ...
          <clipPath id="Map-mask-desktop">
            <use xlinkHref="#Map-globe-desktop"></use>
          </clipPath>
        </defs>
        <g id="Map-texts-desktop">
          <text
            y={positionsDesktop.brPA.y + positionTextShift.y}
            className={classNames(
              styles.pinTextWrapper,
              styles.pinTextWrapper1
            )}
          >
            <tspan
              x={positionsDesktop.brPA.x + positionTextShift.x}
              textAnchor="middle"
              className={styles.pinText}
            >
              {t('map_br_pa')}
          ...
          <text
            y={positionsDesktop.brSC.y + positionTextShift.y}
            className={classNames(
              styles.pinTextWrapper,
              styles.pinTextWrapper2
            )}
          >
            <tspan
              x={positionsDesktop.brSC.x + positionTextShift.x}
              textAnchor="middle"
              className={styles.pinText}
            >
              {t('map_br_sc')}
          ...
          <text
            y={positionsDesktop.brMG.y + positionTextShift.y}
            className={classNames(
              styles.pinTextWrapper,
              styles.pinTextWrapper3
            )}
          >
            <tspan
              x={positionsDesktop.brMG.x + positionTextShift.x}
              textAnchor="middle"
              className={styles.pinText}
            >
              {t('map_br_mg')}
          ...
          <text
            y={positionsDesktop.ch.y + positionTextShift.y}
            className={classNames(
              styles.pinTextWrapper,
              styles.pinTextWrapper4
            )}
          >
            <tspan
              x={positionsDesktop.ch.x + positionTextShift.x}
              textAnchor="middle"
              className={styles.pinText}
            >
              {t('map_ch')}
          ...
          <text
            y={positionsDesktop.ru.y + positionTextShift.y}
            className={classNames(
              styles.pinTextWrapper,
              styles.pinTextWrapper5
            )}
          >
            <tspan
              x={positionsDesktop.ru.x + positionTextShift.x}
              textAnchor="middle"
              className={styles.pinText}
            >
              {t('map_ru')}
          ...
          <text
            y={positionsDesktop.ma.y + positionTextShift.y}
            className={classNames(
              styles.pinTextWrapper,
              styles.pinTextWrapper6
            )}
          >
            <tspan
              x={positionsDesktop.ma.x + positionTextShift.x}
              textAnchor="middle"
              className={styles.pinText}
            >
              {t('map_ma')}
          ...
          <text
            y={positionsDesktop.es.y + positionTextShift.y}
            className={classNames(
              styles.pinTextWrapper,
              styles.pinTextWrapper7
            )}
          >
            <tspan
              x={positionsDesktop.es.x + positionTextShift.x}
              textAnchor="middle"
              className={styles.pinText}
            >
              {t('map_es')}
          ...
          <text
            y={positionsDesktop.tr.y - positionTextShift.y}
            className={classNames(
              styles.pinTextWrapper,
              styles.pinTextWrapper8
            )}
          >
            <tspan
              x={positionsDesktop.tr.x + positionTextShift.x}
              textAnchor="middle"
              className={styles.pinText}
            >
              {t('map_tr')}
        ...
        >
          ...
          <g data-location="BR-sc" className={styles.pin2}>
            <circle
              className={styles.pinBack}
              cx={positionsDesktop.brSC.x}
              cy={positionsDesktop.brSC.y}
              r="2.5"
              fill="#fff"
              fillOpacity="0.5"
            />
          ...
          <g data-location="BR-mg" className={styles.pin3}>
            <circle
              className={styles.pinBack}
              cx={positionsDesktop.brMG.x}
              cy={positionsDesktop.brMG.y}
              r="2.5"
              fill="#fff"
              fillOpacity="0.5"
            />
          ...
          <g data-location="CH" className={styles.pin4}>
            <circle
              className={styles.pinBack}
              cx={positionsDesktop.ch.x}
              cy={positionsDesktop.ch.y}
              r="2.5"
              fill="#fff"
              fillOpacity="0.5"
            />
          ...
          <g data-location="RU" className={styles.pin5}>
            <circle
              className={styles.pinBack}
              cx={positionsDesktop.ru.x}
              cy={positionsDesktop.ru.y}
              r="2.5"
              fill="#fff"
              fillOpacity="0.5"
            />
          ...
          <g data-location="MA" className={styles.pin6}>
            <circle
              className={styles.pinBack}
              cx={positionsDesktop.ma.x}
              cy={positionsDesktop.ma.y}
              r="2.5"
              fill="#fff"
              fillOpacity="0.5"
            />
          ...
          <g data-location="ES" className={styles.pin7}>
            <circle
              className={styles.pinBack}
              cx={positionsDesktop.es.x}
              cy={positionsDesktop.es.y}
              r="2.5"
              fill="#fff"
              fillOpacity="0.5"
            />
          ...
          <g data-location="TR" className={styles.pin8}>
            <circle
              className={styles.pinBack}
              cx={positionsDesktop.tr.x}
              cy={positionsDesktop.tr.y}
              r="2.5"
              fill="#fff"
              fillOpacity="0.5"
            />
  ...
  return (
    <div className={classNames(className, styles.container)}>
      <div className={styles.mapContainer}>
        {/* {isMobileOnly ? <MapMobile /> : <MapDesktop />} */}
        <MapMobile /> <MapDesktop />
      </div>
    </div>
  );
};
